...
- `docs/projects/library-manuscript-skin-mvp/DELIVERY-ROADMAP.md`：登记 Phase 22 主题、与 19–21 的并行关系；
...
**主要文件**：`docs/projects/library-manuscript-skin-mvp/phase22/BASELINE.md`
