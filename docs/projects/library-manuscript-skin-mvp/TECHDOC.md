...
> **归档说明（2026-09-12）**：本文记录已从当前产品移除的历史方案。当前 Renderer 仅保留 modern 单态，请勿据此判断现有实现或继续扩展手稿皮肤。

**文档状态**：本文保留 Phase 1–5 MVP 设计基线；当前实现与验收状态以总体交付路线图为准<br>
**总体交付与后续路线**：[手稿皮肤交付状态与后续路线图](./DELIVERY-ROADMAP.md)<br>
**目标路由**：`/`（`name: 'library'`）  
**目标模块**：`src/renderer/features/library/pages/LibraryPage.vue`  
**视觉风格**：现代流光（`modern`）/ 手稿（`manuscript`）  
**后续技术设计**：[Phase 6：手稿视觉系统固化](./phase6/TECHDOC.md)<br>
...
- TECHDOC：`docs/projects/library-manuscript-skin-mvp/TECHDOC.md`
- 交付记录与矩阵：`docs/projects/library-manuscript-skin-mvp/phase5/DELIVERY.md`
- 截图目录：`docs/projects/library-manuscript-skin-mvp/phase5/screenshots/`
...
完整正文见 [`phase5/DELIVERY.md`](./phase5/DELIVERY.md)。摘要：
