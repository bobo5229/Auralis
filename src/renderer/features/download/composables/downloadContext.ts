...
import {
  useAmdlDownload,
  type UseAmdlDownloadOptions,
  type UseAmdlDownloadReturn,
} from './useAmdlDownload'
 ...
 */
export function provideAmdlDownload(
  optionsOrInstance?: UseAmdlDownloadOptions | UseAmdlDownloadReturn,
): UseAmdlDownloadReturn {
